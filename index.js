...
function reload() {
    ...
    if (randomNumber1===1) {
        ...
        document.querySelector(".dice-image-1").setAttirubte("src", "./images/dice2.png");
    ...
    if (randomNumber1 > randomNumber2) {
        document.querySelector("h1").innerHTML="<img src='./images/finish.png'> Player1 Won!"
    } else if (randomNumber1 < randomNumber2) {
        document.querySelector("h1").innerHTML="Player2 Won <img src='./images/finish.png'>"
    } else {
        document.querySelector("h1").innerHTML="<img src='./images/finish.png'> You Are Tie <img src='./images/finish.png'>"
    }
}